                ...
                data: [
                    {
                        ...
                        Professor Aurelia, Keeper of Secrets, welcomes the apprentice and explains that every student must create a magical Spellkey to protect their personal vault.
                        However, she warns that many students choose weak Spellkeys. And something in the castle has learned to exploit them.
                        `,
                        narration_GER: `Ein junger Lehrling,Alex, kommt an der renommierten Akademie des Arkanen Wissens an.
                        In der Halle der Geheimnisse befindet sich ein uralter Tresor, in dem mächtige magische Artefakte und verborgenes Wissen aufbewahrt werden.
                        Professorin Aurelia, die Hüterin der Geheimnisse, heißt den Lehrling willkommen und erklärt ihm, dass jeder Schüler einen eigenen magischen Spellkey erschaffen muss, um seinen persönlichen Tresor zu schützen.
                        Sie warnt ihn jedoch, dass viele Schüler zu schwache Spellkeys wählen. Und etwas im Schloss hat bereits gelernt, diese Schwächen auszunutzen.
                        `,
                    ...
                    },
                    {
                        ...
                        narration_EN: `Professor Aurelia leads the apprentice beneath the castle.
                    ...
                    },
                    {
                        ...
                        narration_EN: `The professor takes the apprentice to the Library of Unusual Things. She explains that strong Spellkeys are built from unexpected combinations.
                    ...
                    },
                    {
                        ...
                        The Mimics emerge and attempt to imitate common Spellkeys. But they cannot understand the unique combination.
                        ...
                        Die Mimics tauchen auf und versuchen, gewöhnliche Spellkeys nachzuahmen. Doch sie können die einzigartige Kombination nicht entschlüsseln.
                        Ihre Schatten lösen sich auf. Die Runen des Tresors erwachen zum Leben.
                        ...
                        She leads the apprentice to the Hall of Echoes, where countless magical vaults shimmer throughout the kingdom. The apprentice notices many vaults glowing with the same magical signature.
                        "They all use the same Spellkey?" the apprentice asks.
                        ...
                        One… Then another… Then dozens more. The apprentice watches in disbelief. "So one stolen Spellkey can unlock many vaults?"
                        `,
                        ...
                        Sie führt den Lehrling in die Halle der Echos, wo unzählige magische Tresore aus dem ganzen Königreich schimmern. Der Lehrling bemerkt, dass viele Tresore dieselbe magische Signatur tragen.
                        ...
                        Die Mimics ziehen von Tresor zu Tresor und testen die gestohlene Magie. Jeder Tresor, der mit demselben Spellkey geschützt ist, öffnet sich ohne Widerstand.
                        Einer … Dann ein weiterer … Dann Dutzende mehr.
                        Der Lehrling beobachtet alles ungläubig. „Das bedeutet also, dass ein einziger gestohlener Spellkey viele Tresore öffnen kann?“
                        `,
                        },
                    {
                        scene_id: 6,
                        ...
                        The apprentice returns to the Hall of Secrets and forges a different Spellkey for every important vault.
                        When the Shadow Mimics return, they try the stolen Spellkey again. The first vault opens. But every other vault remains sealed. Confused, the Mimics retreat into the darkness.
                        Professor Aurelia smiles. "A unique Spellkey should protect a unique vault."
                        Professor Aurelia watches as the apprentice finishes securing each vault.
                        "You have learned an important lesson.Every vault deserves its own unique Spellkey."
                        `,
                        ...
                        Der Lehrling kehrt in die Halle der Geheimnisse zurück und schmiedet für jeden wichtigen Tresor einen anderen Spellkey.
                        Als die Schatten-Mimics zurückkehren, versuchen sie es erneut mit dem gestohlenen Spellkey.Der erste Tresor öffnet sich.Doch alle anderen Tresore bleiben verschlossen. Verwirrt ziehen sich die Mimics in die Dunkelheit zurück.
                        Professorin Aurelia lächelt. „Ein einzigartiger Spellkey sollte einen einzigartigen Tresor schützen.“
                        Professorin Aurelia beobachtet, wie der Lehrling jeden einzelnen Tresor absichert.
                        „Du hast eine wichtige Lektion gelernt. Jeder Tresor verdient seinen eigenen einzigartigen Spellkey.“
                        `,
                    },
                    {
                        scene_id: 7,
                        ...
                        narration_EN: `Days pass, and the apprentice now protects dozens of magical vaults across the kingdom.
                        The apprentice looks at the countless Spellkeys they have created. "Professor, how can I remember every Spellkey?"
                        Professor Aurelia leads the apprentice to an ancient chamber beneath the academy. There rests a glowing, magical tome covered in golden runes.
                        "This is the Book of Infinite Keys," she explains. The book safely stores every unique Spellkey created by a guardian.
                        The apprentice opens the tome, and countless Spellkeys appear within its pages. "With this book, you need only remember one Master Spell to protect them all."
                        The apprentice watches as the tome creates a new, powerful Spellkey for a newly created vault. No patterns. No repetition. No weaknesses. 
                        Professor Aurelia smiles. "A wise guardian does not use the same Spellkey everywhere.They create unique ones...And use the right magic to remember them."
                        `,
                        narration_GER: `Einige Tage vergehen, und inzwischen schützt der Lehrling Dutzende magische Tresore im ganzen Königreich.
                        Der Lehrling betrachtet die unzähligen Spellkeys, die er erschaffen hat. „Professorin, wie soll ich mir jeden einzelnen Spellkey merken?“
                        Professorin Aurelia führt den Lehrling in eine uralte Kammer unterhalb der Akademie. Dort liegt ein leuchtendes magisches Buch, dessen Einband mit goldenen Runen bedeckt ist.
                        „Dies ist das Buch der unendlichen Schlüssel“, erklärt sie. Das Buch bewahrt jeden einzigartigen Spellkey, den ein Hüter erschaffen hat, sicher auf.
                        Der Lehrling öffnet das Buch, und auf seinen Seiten erscheinen unzählige Spellkeys. „Mit diesem Buch musst du dir nur einen einzigen Meisterzauber merken, um sie alle zu schützen.“
                        Der Lehrling beobachtet, wie das Buch für einen neu errichteten Tresor einen neuen, mächtigen Spellkey erschafft.
                        Keine Muster. Keine Wiederholungen. Keine Schwächen.
                        Professorin Aurelia lächelt. „Ein weiser Hüter verwendet nicht überall denselben Spellkey. Er erschafft einzigartige Spellkeys…Und nutzt die richtige Magie, um sie sich zu merken.“
                        `,
                    },
                ]
            },
